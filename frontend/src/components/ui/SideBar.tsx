...
const SideBar: React.FC = () => {
  ...
  return (
    <div className={`fixed left-0 top-0 h-full bg-gray-800 border-r border-gray-600 transition-all duration-300 ease-in-out z-50 ${
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="space-y-2">
          {isExpanded && <h3 className="text-sm font-medium text-gray-300 mb-3">Navigation</h3>}
        ...
        <div className="space-y-4">
          {isExpanded && <h3 className="text-sm font-medium text-gray-300 mb-3">Drawing Tools</h3>}
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-3">
              ...
              {isExpanded && <span className="text-sm text-gray-400">Color</span>}
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-3">
              ...
              {isExpanded && <span className="text-sm text-gray-400">Size</span>}
            </div>
