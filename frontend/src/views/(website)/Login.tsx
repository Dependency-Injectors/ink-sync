...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center grow dark:text-white bg-linear-to-br ">
      <form
        action={handleLogin}
      ...
      >
        ...
        <button
          type="submit"
          className="mt-4 p-3 rounded-md bg-petrol-500 text-white font-semibold hover:bg-petrol-400 dark:hover:bg-petrol-600 focus:outline-none focus:ring-2 focus:ring-petrol-500"
        >
          Log In
        </button>
      </form>
