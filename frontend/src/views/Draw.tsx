...
const Draw = () => {
  ...
  useEffect(() => {
    ...
    const websocket = new WebSocket(`ws://localhost:3007/draw?id=${userId.current}`);
  ...
  const handleMouseDown = (e: React.MouseEvent) => {
    ...
    handleLocalDrawEvent({ type: 'start', x, y, userId: userId.current, strokeId });
  };
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    handleLocalDrawEvent({ type: 'draw', x, y, userId: userId.current, strokeId: currentStrokeId });
  };
  ...
  const handleMouseUp = (e: React.MouseEvent) => {
    ...
    handleLocalDrawEvent({ type: 'end', x, y, userId: userId.current, strokeId: currentStrokeId });
